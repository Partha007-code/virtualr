...
const Pricing = () => {
  return (
    <div className="mt-20">
      <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center my-8 trzcking-wider">
        Pricing
      </h2>
        ...
        {pricingOptions.map ((option, index)=>(
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
            <div className="p-10 border border-neutral-700 rounded-xl">
              ...
              {option.title === "Pro" && <span className="text-xl bg-gradient-to-r from-orange-500 to-orange-800 bg-clip-text text-transparent mb-4 ml-2">(Most Popular)</span>}
              </p>
              <p className="mb-8">
